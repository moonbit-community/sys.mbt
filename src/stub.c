...
#include "moonbit.h"
typedef int32_t moonbit_bool_t;
...
moonbit_bool_t moonbit_errno_is_interrupted() {
    return false;
}
...
MOONBIT_EXPORT moonbit_bool_t moonbit_file_is_invalid(FILE file) {
...
MOONBIT_EXPORT moonbit_bool_t moonbit_create_dir(moonbit_bytes_t filename) {
...
MOONBIT_EXPORT moonbit_bool_t moonbit_remove_dir(moonbit_bytes_t filename) {
...
MOONBIT_EXPORT moonbit_bool_t moonbit_file_metadata(FILE file, FILE_STAT stat) {
...
MOONBIT_EXPORT moonbit_bool_t moonbit_file_close(FILE file) {
...
MOONBIT_EXPORT moonbit_bool_t moonbit_create_dir(moonbit_bytes_t dirname) {
    // 0o755 = (7 × 8^2) + (5 × 8^1) + (5 × 8^0) = 448 + 40 + 5 = 493
    return mkdir(dirname, 0755) != -1;
}
MOONBIT_EXPORT moonbit_bool_t moonbit_remove_dir(moonbit_bytes_t dirname) {
...
// MOONBIT_EXPORT moonbit_bool_t moonbit_file_symlink_metadata(moonbit_bytes_t file, FILE_STAT stat) {
